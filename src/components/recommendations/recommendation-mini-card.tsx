...
type RecommendationMiniCardProps = {
  row: RecommendationRow;
};

export function RecommendationMiniCard({ row }: RecommendationMiniCardProps) {
...
/** @deprecated Use RecommendationMiniCard */
export const RecommendationCard = RecommendationMiniCard;
